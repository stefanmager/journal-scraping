...
# However, keep in mind that you might be blocked by the aom website if you 
...
def start_scraping():
    scrape_articles(url='https://journals.aom.org/toc/amj/current', outlet="amj")
    scrape_articles(url='https://journals.aom.org/toc/amr/current', outlet="amr")
...
def scrape_articles(url, outlet, skip=False):
    ...
    for i in issue_items:
        ...
        all_authors = i.findAll(class_="rlist--inline loa")
        ...
        current_article_links = "https://journals.aom.org" + h5_link.attrs["href"]
