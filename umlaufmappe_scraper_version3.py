...
def start_scraping():
    scrape_articles(url='https://pubsonline.informs.org/toc/isre/current', outlet="isre")
...
def scrape_articles(url, outlet):
    ...
    for i in issue_items:
        ...
        h5_link = i.find("a")
        # TODO: Potential Issue if you scrape other sites apart from informs
    ...
    with open(outlet_csv_file_name, 'w') as output_file:
